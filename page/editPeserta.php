...
<div class="container p-3 m-4 h-100" style="background-color: #FFFFFF; border-top: 5px solid #17337A; boxshadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);" >
    ...
    <?php
        ...
        echo'
        <form action="../process/editMahasiswaProcess.php?id='.$data['id'].'" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="npm" name="npm" aria-describedby="emailHelp" value="'.$data['npm'].'">
            </div>

            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Prodi</label>
                <select class="form-select" aria-label="Default select example" name="prodi" id="prodiTest">
 ...
 <script>
    var prodi = '<?= $prodi?>'
    document.getElementById('prodiTest').value = prodi;
 </script>
</body>
</html>